...
public class TestRCBoat {
    ...
    public void testFirstRCBoat() {
        ...
        expected += "\tBlackPearl races around at 10 knots!";
        ...
        expected += "\tBlackPearl races around at 15 knots!";
        assertEquals(expected, outputStreamCaptor.toString()
                .trim());
        ...
        expected += "\tBlackPearl races around at 20 knots!" +  System.lineSeparator();
    ...
    public void testSecondRCBoat() {
        ...
        expected += "\tTheORCA races around at 10 knots!" + System.lineSeparator();
        ...
        expected += "\tTheORCA races around at 15 knots!";
        assertEquals(expected, outputStreamCaptor.toString()
                .trim());
